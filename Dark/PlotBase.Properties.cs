...
namespace OxyPlot.Dark.Wpf
{
    ...
    public partial class PlotBase
    {
        ...
        /// <summary>
        /// Identifies the <see cref="HorizontalDefaultTrackerTemplate"/> dependency property.
        /// </summary>
        public static readonly DependencyProperty HorizontalDefaultTrackerTemplateProperty =
            DependencyProperty.Register(
                "HorizontalDefaultTrackerTemplate", typeof(ControlTemplate), typeof(PlotBase), new PropertyMetadata(null));
        ...
        /// Gets or sets the default tracker template.
        /// </summary>
        public ControlTemplate HorizontalDefaultTrackerTemplate
        {
            get
            {
                return (ControlTemplate)this.GetValue(HorizontalDefaultTrackerTemplateProperty);
            }

            set
            {
                this.SetValue(HorizontalDefaultTrackerTemplateProperty, value);
            }
        }
